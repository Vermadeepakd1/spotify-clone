...
let play = document.querySelector(".play img"); // Define the play button
...
async function getSongs(folder) {
    try {
        ...
        console.log("Found links:", as.length); // Debugging
        ...
        console.log("Songs found:", songs); // Debugging
        ...
        for (let i = 0; i < array.length; i++) {
            ...
            if (e.href.includes("/songs/") && !e.href.includes(".htaccess")) {
                ...
                try {
                    ...
                    if (!info.ok) {
                        throw new Error(`Failed to fetch album info: ${info.status} ${info.statusText}`);
                    }
                        ...
                        <div class="card" data-folder="songs/${folder}">
                            ...
                            <div class="play">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="60" height="60" fill="none">
                                    ...
                                    <path d="M9 7L17 12L9 17V7Z" fill="black" stroke="black" stroke-width="1.5" stroke-linejoin="round" />
                                </svg>
                            </div>
                        </div>
                    `;
