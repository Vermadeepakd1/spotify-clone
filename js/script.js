...
async function getSongs(folder) {
    try {
        ...
        let a = await fetch(`https://vermadeepakd1.github.io/spotify-clone/${currentfolder}/`);
        ...
        for (let i = 0; i < as.length; i++) {
            ...
            if (href && href.endsWith(".mp3")) {
                let fullUrl = new URL(href, `https://vermadeepakd1.github.io/spotify-clone/${currentfolder}/`).href;
